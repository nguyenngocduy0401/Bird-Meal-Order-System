...
public class PagingStaffProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            out.print(" <table class=\"table table-bordered\" id=\"dataTable\" width=\"100%\" cellspacing=\"0\">\n"
                    + "                    <thead>\n"
                    + "                        <tr>\n"
                    + "                            <th>imgPath</th>\n"
                    + "                            <th>Name</th>\n"
            ...
            result.forEach((dto) -> {
                out.print("<tr>\n"
                        ...
                        + "                                                                <a href=\"UpdateProductServlet?action=edit&txtProductId=" + dto.getProductID() + "\">\n"
                        + "                                                                    Edit\n"
                        + "                                                                    <i class=\"bi bi-pencil\"></i>\n"
                        + "                                                                </a>\n"
                        + "                                                            </button>\n"
                        + "                                    <button class=\"btn btn-danger\">\n"
                        + "                                                                <a href=\"HideProduct?productID=" + dto.getProductID() + "&status=0\" style=\"color: white;\">\n"
                        + "                                                                    Hide\n"
