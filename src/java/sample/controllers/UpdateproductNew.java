 ...
 * @author DucAnh
 */
@WebServlet(name = "UpdateproductNew", urlPatterns = {"/UpdateproductNew"})
public class UpdateproductNew extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateproductNew.class.getName()).log(Level.SEVERE, null, ex);
