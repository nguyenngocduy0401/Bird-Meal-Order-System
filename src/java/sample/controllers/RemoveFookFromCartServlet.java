 ...
 * @author DucAnh
 */
@WebServlet(name = "RemoveFookFromCartServlet", urlPatterns = {"/RemoveFookFromCartServlet"})
public class RemoveFookFromCartServlet extends HttpServlet {
...
//                    + "?btAction=View Your Cart";
    ...
    try {
        ...
        Logger.getLogger(RemoveFookFromCartServlet.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
