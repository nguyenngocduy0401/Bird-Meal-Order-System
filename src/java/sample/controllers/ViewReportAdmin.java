 ...
 * @author Admin
 */
@WebServlet(name = "ViewReportAdmin", urlPatterns = {"/ViewReportAdmin"})
public class ViewReportAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ViewReportAdmin.class.getName()).log(Level.SEVERE, null, ex);
